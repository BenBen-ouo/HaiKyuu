...
public final class GameConfig {
    ...
    public static final double RED_WING_OFFSET_X = -167 - PLAYER_IMAGE_WIDTH + PLAYER_NET_OVERLAP_X; //照比例換算 300 * 5/9
    ...
    public static final double BLUE_WING_OFFSET_X = 167 - PLAYER_NET_OVERLAP_X; //照比例換算 300 * 5/9
